...
As noted by Jack and Oster [-@Jack_Oster_2023], it can be seen that the equity impacts are two-fold. First, as shown in @fig-race, schools (and students) of more vulnerable racial backgrounds -- especially, Black and Hispanic -- are less likely to have access to in-person instruction. Second, as shown in @fig-mathscoresrace and @fig-elascoresrace, for such groups, the consequences of a lack of in-person instruction on academic performance are more severe. 
