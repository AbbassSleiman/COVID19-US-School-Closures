...
Moreover, data from CSDH [@citeraw1], NCES [@citeraw2] and Microsoft [@kahan2020usbroadband] were used to show correlations between school closures and demographic characteristics, both across and within US states. We reconstruct and extend a portion of the data used for this analysis in Figures \ref{fig-broadband} and \ref{fig-white}. In particular, we enrich the analysis on the average days in virtual school by race, by adding shares of White and Asian students. This is done so that more insightful comparisons can be made across important ethnic classes. 

Figure \ref{fig-broadband} shows correlations ... Altogether, school districts located in counties with lower broadband usage spent more of the 2020-2021 school year in virtual learning, consistent with the results obtained by Jack and Oster [-@Jack_Oster_2023]. 
...
On the other hand, Figure \ref{fig-white} shows correlations [ADD DETAIL]. In particular, within state, school districts with higher shares of Black and Hispanic students spent more of the 2020-2021 year in virtual schooling than those with lower shares of Black and Hispanics. Precisely the opposite trend is observed for white students. No significant variation in the days spent in virtual schooling is observed for Asian students. [ADD MORE DETAIL]
...
Taken together, in-person education was inequitably distributed across demographic characteristics, with more disadvantaged districts spending more time in virtual schooling [@Jack_Oster_2023]. In particular, districts with less technological preparedness and higher shares of minorities -- especially Blacks and Hispanics -- were further disenfranchised by less access to in-person education. This pattern likely reinforced educational inequities between vulnerable and more privileged groups. 
